...
public class Alarm implements Parcelable {
	public int id;
	public boolean enabled;// 闹铃是否可用
	public int hour;// 时
	public int minutes;// 分
	public DaysOfWeek daysOfWeek;// 响铃星期
	public long time;// 时间
	public boolean vibrate;// 是否振动
	public String label;// 标签
	public Uri alert;// 铃音
	public boolean silent;// 是否静音
	public int times;// 响铃次数
	public int interval;// 重复间隔时间
	...
	public static class Columns implements BaseColumns {
         ...
         */
        public static final Uri CONTENT_URI = Uri.parse("content://com.wisesean.heartbeat.alarm/alarm");
